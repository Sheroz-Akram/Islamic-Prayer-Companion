...
class CustomAdapterTasbeeAdapter(var context: Context, var arrayList: java.util.ArrayList<Tasbee>) : BaseAdapter() {
    ...
    override fun getView(position: Int, convertView: View?, parent: ViewGroup?): View {
        ...
        simpleTitle.setText((position + 1).toString() + "- " + arrayList.get(position).Name)
        return convertView
    }
